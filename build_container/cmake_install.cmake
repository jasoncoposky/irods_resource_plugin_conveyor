# Install script for directory: /irods_plugin_source
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/usr/lib/irods/plugins/resources" TYPE MODULE FILES "/irods_plugin_build/libirods_resource_plugin_conveyor.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/irods/plugins/resources/libirods_resource_plugin_conveyor.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/lib/irods/plugins/resources/libirods_resource_plugin_conveyor.so")
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/var/lib/irods/scripts/irods/test" TYPE FILE PERMISSIONS OWNER_READ OWNER_WRITE GROUP_READ WORLD_READ FILES "/irods_plugin_source/packaging/test_irods_resource_plugin_conveyor.py")
endif()
...
file(WRITE "/irods_plugin_build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
